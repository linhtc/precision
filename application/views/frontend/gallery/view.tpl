      ...
      <div class="container">
        ...
        <div class="row offset"> 
          <div class="col-lg-7 col-xs-7">
            <div class="product pr-img-09 bg-100p-pr wow fadeInUp" style="background-image: url({base_url()}media/uploads/images/project_05.jpg);">
              <a href="#" class="product_cont">
                <h3>Project #5</h3>
                <i class="icon primary-icon icon-sm material-icons-keyboard_arrow_right"></i>
              </a>
          ...
          <div class="col-lg-5 col-xs-5 offset-7">
            <div class="product pr-img-10 bg-100p-pr wow fadeInUp" style="background-image: url({base_url()}media/uploads/images/project_06.jpg);">
              <a href="#" class="product_cont">
                <h3>Project #6</h3>
                <i class="icon primary-icon icon-sm material-icons-keyboard_arrow_right"></i>
              </a>
