<!--======================well-1=========================-->
    <section class="well-2 bg-primary border">
      <div class="container">
        <h2 class="secondary_color center_text">About us</h2>
...
<!--======================End well-1=========================-->
<!--======================parallax=========================-->
  <section style="margin-top: 85px;" class="parallax well-2" data-url="https://livedemo00.template-help.com/wt_59561/images/page-02_bg-02.jpg" data-mobile="true" data-speed="0.6">
    <div class="container">
