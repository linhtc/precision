	                    ...
	                    <div class="col-md-6">
	                        <form>
	                            <div class="form-group">
	                                ...
	                                <input id="title" type="text" class="form-control params" notnull value="{$item->title}" placeholder="{lang('input_value')}" >
	                                <input id="id" type="hidden" class="form-control params" notnull value="{$item->id}" readonly >
	                            </div>
	                        </form>
	                    </div>
	                    <div class="col-md-6">
	                        <form>
	                            <div class="form-group">
	                                ...
	                                <input id="image" onclick="changePhoto();" type="text" class="form-control params" notnull value="{$item->image}" readonly style="cursor: pointer;" placeholder="{lang('choose_image')}" >
	                    ...
	                    <div class="col-md-12">
	                        <form>
	                            <div class="form-group">
	                                ...
	                                <textarea id="summary" rows="3" cols="1" class="form-control params" notnull placeholder="{lang('input_value')}" >{$item->summary}</textarea>
	                            </div>
	                        </form>
	                    </div>
                	</div>
	                    ...
	                    <div class="col-md-12">
	                        <form>
	                            <div class="form-group">
	                                ...
	                                <textarea id="content" rows="1" cols="1" class="form-control params" notnull >{$item->content}</textarea>
	                            </div>
	                        </form>
	                    </div>
                	</div>
