                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <select id="kind" class="form-control selectpicker params" notnull>
                                    <option value="default" selected="selected">{lang('default')}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control params" id="vi" notnull >
                            </div>
                            <div class="form-group">
                                <label for="en">{lang('en')}</label>
                                <input type="text" class="form-control params" id="en" notnull >
                            </div>
                        </form>
                    </div>
                </div>
