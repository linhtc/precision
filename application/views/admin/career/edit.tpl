                		...
                		<div class="row">
	                		<div class="col-md-6">
							    <div class="form-group">
	                                ...
	                                <input id="page_job" placeholder="Nhập một giá trị..." type="text" class="form-control params" value="{$thisItem->page_job}">
	                            </div>
	                		</div>
	                		<div class="col-md-6">
							    <div class="form-group">
							        <label for="page_pos">Vị trí</label>
							        <input id="page_pos" placeholder="Nhập một giá trị..." notnull type="text" class="form-control params" value="{$thisItem->page_pos}">
							    </div>
	                		</div>
                		</div>
                		<div class="row">
	                		<div class="col-md-6">
							    <div class="form-group">
							        ...
							        <input id="page_time" placeholder="Nhập một giá trị..." notnull type="text" class="form-control params" value="{$thisItem->page_time}">
							    </div>
	                		</div>
	                		<div class="col-md-6">
							    <div class="form-group">
							        <label for="page_quan">Số lượng</label>
							        <input id="page_quan" placeholder="Nhập một giá trị..." notnull type="text" class="form-control params" value="{$thisItem->page_quantity}">
							    </div>
	                		</div>
                		</div>
                		<div class="row">
	                		<div class="col-md-12">
							    <div class="form-group">
							        ...
							        <textarea id="page_require" placeholder="Nhập một giá trị..." rows="5" cols="1" notnull class="form-control params">
							        {$thisItem->page_require}
							         </textarea>
							    </div>
	                		</div>
                		</div>
