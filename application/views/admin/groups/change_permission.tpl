...
<script src="{base_url()}static/default/admin/template/plugins/jstree/jstree.min.js"></script>
<script>
    ...
    function showAlert(content) {
        $('#my-modal-alert').modal({
            ...
            window.location = '{base_url()}admin/groups/view';
        });
    ...
    function submitChange() {
        ...
        $.post(formURL, postData, function (data) {
            ...
            if (data == 1) {
                ...
                setTimeout(function(){ window.location = '{base_url()}admin/groups/view'; }, 2000);
            } else{
